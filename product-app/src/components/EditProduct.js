...
// let [prodcutDetail, setProductDetail] = useState({
//     Name: "",
//     MaxRetailPrice: 0.0,
//     Price: 0.0,
//     ProductUrl: "",
    ...
    const formik = useFormik({
      ...
      let saveHandler = async(data)=>{
        try {
            ...
            await axios
            .put(
              `https://614eac01b4f6d30017b482dc.mockapi.io/Products/${params.id}`, data
            ).then((data) => {
      ...
      useEffect(()=>{
        if(productID){
            ...
            let getData = async () => {
                await fetch(
                  "https://614eac01b4f6d30017b482dc.mockapi.io/Products/" + productID,
                  { method: "GET" }
                )
            ...
            <div className="col-6">
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="Color"
                  onChange={formik.handleChange}
                  value={formik.values.Color === undefined ? '' : formik.values.Color}
                />
              </div>
            </div>
          </div>
